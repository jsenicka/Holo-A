...
Function cbConfigurator
{
    ...
    Param (
        ...
        [Net.IPAddress]$DhcpIPSubnet = "10.0.26.0",
        [INT]$DhcpSubnetCIDR = "24",
        [Net.IPAddress]$DhcpGateway = "10.0.26.1",
        [parameter(Mandatory=$true)]
...
function setFormControls ($formway)
{
    ...
    switch ($formway)
    {
        ...
        'internalsvcs' {
                        ...
                        $lblBringUpFile.visible = $true
                        $txtBringUpFile.visible = $true
                        $txtBringUpFile.Text = "$scriptDir\Holo-A-NOLIC-44-TMM-vcf-ems-public.json"
